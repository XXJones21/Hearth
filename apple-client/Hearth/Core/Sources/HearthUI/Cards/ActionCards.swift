...
// `.hearthChoicePicked` used to be declared here. It moved to HearthCore's
// UiComponentDescriptor.swift when the package split, next to the card model it
// belongs to and within reach of ChatViewModel, which is the observer. That
// also matches where the other two names live: beside ServerConfig and
// SessionModels respectively, never beside the view that posts them.
